...
def main():
    ...
    fluxSP2 = open("fluxSP2.txt","w")
    varianceSP2 = open("varianceSP2.txt","w");
    deviationSP2 = open("deviationSP2.txt","w");
    coordSP2 = open("coordSP2.txt","w")
    ...
    file.write("   |          SP2 EQUATIONS (1D - Continuous source)          |\n")
    ...
    file.close(); 
    for i in range(len(flux_local)):
        fluxSP2.write("   "+ str(flux_local[i])+"\n");
    for i in range(len(flux_local)):
        coordSP2.write("   "+ str(z)+"\n");
        z = z + step
    for i in range(len(flux_local)):
        varianceSP2.write("   "+ str(variancepic[i])+"\n");
    for i in range(len(flux_local)):
        deviationSP2.write("   "+ str(variancepic[i])+"\n");
    deviationSP2.close()                     
    varianceSP2.close()     
    fluxSP2.close();
    coordSP2.close();              
