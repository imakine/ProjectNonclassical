...
def main():
    ...
    fluxSP3 = open("fluxSP3.txt","w")
    varianceSP3 = open("varianceSP3.txt","w");
    deviationSP3 = open("deviationSP3.txt","w");
    coordSP3 = open("coordSP3.txt","w")
    ...
    file.write("   |         SP3 EQUATIONS (1D - Continuous source)           |\n")
   ...
   for i in range(len(flux_local)):
    ...
    file.close();
    for i in range(len(flux_local)):
        fluxSP3.write("   "+ str(flux_local[i])+"\n");
    for i in range(len(flux_local)):
        coordSP3.write("   "+ str(z)+"\n");
        z = z + step
    for i in range(len(flux_local)):
        varianceSP3.write("   "+ str(variancepic[i])+"\n");
    for i in range(len(flux_local)):
        deviationSP3.write("   "+ str(variancepic[i])+"\n");
    deviationSP3.close()                     
    varianceSP3.close()      
    fluxSP3.close();
    coordSP3.close();          
